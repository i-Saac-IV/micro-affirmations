...
LedPinConfig_t columns[ELECTRICAL_COLS] = {
    {MATRIX_K0_GPIO_Port, MATRIX_K0_Pin, GPIO_PIN_SET},
    {MATRIX_K1_GPIO_Port, MATRIX_K1_Pin, GPIO_PIN_SET},
    {MATRIX_K2_GPIO_Port, MATRIX_K2_Pin, GPIO_PIN_SET},
    {MATRIX_K3_GPIO_Port, MATRIX_K3_Pin, GPIO_PIN_SET},
    {MATRIX_K4_GPIO_Port, MATRIX_K4_Pin, GPIO_PIN_SET},
    {MATRIX_K5_GPIO_Port, MATRIX_K5_Pin, GPIO_PIN_SET},
    {MATRIX_K6_GPIO_Port, MATRIX_K6_Pin, GPIO_PIN_SET},
    {MATRIX_K7_GPIO_Port, MATRIX_K7_Pin, GPIO_PIN_SET},
    {MATRIX_K8_GPIO_Port, MATRIX_K8_Pin, GPIO_PIN_SET},
    {MATRIX_K9_GPIO_Port, MATRIX_K9_Pin, GPIO_PIN_SET}
};
